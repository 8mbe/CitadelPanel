...
function collectSelectItems(
  ...
  React.Children.forEach(node, (child) => {
    ...
    // Recurse so items nested under SelectContent / SelectGroup / fragments are found.
    if (props.children) collectSelectItems(props.children, map)
  })
}
...
function Select<Value, Multiple extends boolean | undefined = false>({
  ...
  // Respect an explicit `items` prop; otherwise derive one from the item labels.
